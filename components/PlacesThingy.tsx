      ...
      <section className="flex-row items-center justify-center my-48">
        ...
        <div className="flex items-center justify-center transition-all duration-500">
          <Link
            ...
            target="_blank"
            className="group w-full bg-whitex/90 px-6 py-4 rounded-xl mt-12 hover:bg-whitex text-center text-redx text-xl transition-all duration-500 active:scale-95 hover:scale-105"
          >
            Open Map
